...
const useRegister = (setIsOpen, initialRole = "user") => {
  const [formData, setFormData] = useState({
    email: "",
    name: "",
    password: "",
    c_password: "",
    role: initialRole, // Set initial role dynamically based on the prop
  });

  const setRole = (role) => {
    setFormData((prevState) => ({
      ...prevState,
      role, // Update role based on button click
    }));
  };
  ...
  useEffect(() => {
    setFormData((prevState) => ({
      ...prevState,
      role: initialRole, // Update role when component mounts
    }));
  }, [initialRole]);
  ...
  return { handleFormRegister, setFormData, setRole, formData };
};
