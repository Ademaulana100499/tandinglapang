...
export const CostBreakdownModal = ({ isOpen, setIsOpen, activityData }) => {
  ...
  // Biaya tambahan per ID metode pembayaran
  const paymentMethodFees = {
    1: 4000, // Contoh: ID metode pembayaran 1 menambahkan biaya 4000
    2: 3000, // Contoh: ID metode pembayaran 2 menambahkan biaya 3000
    3: 4000,
    4: 5000,
    // Tambahkan lebih banyak ID dan biaya sesuai kebutuhan
  };
