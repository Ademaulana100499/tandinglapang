...
export const CostBreakdownModal = ({ isOpen, setIsOpen, data }) => {
  ...
  const handlePayment = async () => {
    ...
    const payload = {
      sport_activity_id: data?.id, // Mengambil ID aktivitas dari data
      payment_method_id: selectedPaymentMethod.id, // ID metode pembayaran yang dipilih
    };
    ...
    try {
      ...
      setIsOpen(false); // Menutup modal setelah berhasil
    } catch (error) {
      alert(error.message);
