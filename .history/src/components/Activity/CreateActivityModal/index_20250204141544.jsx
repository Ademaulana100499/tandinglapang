                ...
                <div className="relative w-full">
                  <span
                    className={`absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 ${
                      formData.start_time ? "hidden" : "block"
                    }`}>
                    Jam Mulai
                  </span>
                  <input
                    ...
                    min={currentTime}
                    className="p-2 rounded border border-gray-300 focus:ring-2 focus:ring-green-500 w-full bg-transparent"
                  />
                </div>
                <div className="relative w-full">
                  <span
                    className={`absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 ${
                      formData.end_time ? "hidden" : "block"
                    }`}>
                    Jam Selesai
                  </span>
                  <input
                    ...
                    className="p-2 rounded border border-gray-300 focus:ring-2 focus:ring-green-500 w-full bg-white appearance-none"
                  />
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
