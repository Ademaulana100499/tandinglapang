            ...
            <div className="relative w-full h-full p-4">
              <div className="absolute top-0  left-0 w-full gap-2 ">
                <motion.div
                  ...
                  animate="open"
                  exit="closed"
                  className="px-4 text-xs xl:text-base py-2 bg-black/40 backdrop-blur-sm text-white inline-block">
                  <p>{item}</p>
                </motion.div>
              ...
              <div className="absolute text-xs xl:text-base bottom-0 right-0">
                <motion.div
                  ...
                  animate="open"
                  exit="closed"
                  className="px-8 py-2 text-xs xl:text-base bg-black/40 backdrop-blur-sm hover:bg-black transition-colors text-white">
