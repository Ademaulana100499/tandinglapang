            ...
            <div className="relative w-full h-full p-4">
              <div className="absolute top-0  left-0 w-full gap-2 ">
                <motion.div
                  ...
                  animate="open"
                  exit="closed"
                  className="px-4 text-xs xl:text-base  bg-black/10 backdrop-blur-sm text-white inline-block">
                  <p>{item}</p>
                </motion.div>
                ...
                <motion.div
                  ...
                  animate="open"
                  exit="closed"
                  className="px-4  text-xs xl:text-base absolute top-0 right-0 bg-black/40 backdrop-blur-sm text-white inline-block">
                  <p>{sport_category}</p>
                </motion.div>
              </div>
