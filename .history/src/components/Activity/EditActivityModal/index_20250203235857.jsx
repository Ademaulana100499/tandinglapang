...
export const EditActivityModal = ({ isOpen, setIsOpen, activityData }) => {
  ...
  // Menyimpan activityData ke formData jika activityData tersedia
  useEffect(() => {
    if (activityData) {
      ...
      {isOpen && (
        <motion.div
          ...
          <motion.div
            ...
            className="bg-white p-6 shadow-xl w-full sm:max-w-md md:max-w-lg lg:max-w-3xl text-gray-800 relative rounded-lg">
            <h3 className="text-xl font-bold mb-2 text-center">Edit Acara</h3>
            <p className="text-gray-600 text-sm mb-4 text-center">
              Perbarui informasi acara Anda.
            </p>
            <form
              className="w-full grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4"
