...
import useEditActivity from "@/hooks/useCreateActivity";
...
export const EditActivityModal = ({ isOpen, setIsOpen, activityData }) => {
  const { formData, setFormData, handleFormEdit, isLoading } =
    useEditActivity();
        ...
        <motion.div
          ...
          <motion.div
            ...
            <form
              ...
              <input
                type="text"
                placeholder={activityData.address}
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <input
                  type="number"
                  placeholder={activityData.price}
              ...
              <div className="grid grid-cols-2 gap-4">
                <input
                  type="date"
                  placeholder={activityData.activity_date}
                ...
                <input
                  type="text"
                  placeholder={activityData.map_url}
              ...
              <div className="grid grid-cols-2 gap-4">
                <input
                  type="time"
                  placeholder={activityData.start_time}
                ...
                <input
                  type="time"
                  placeholder={activityData.end_time}
