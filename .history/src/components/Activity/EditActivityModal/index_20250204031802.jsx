        ...
        <motion.div
          ...
          <motion.div
            ...
            <form
              ...
              <div className="grid text-xs grid-cols-1 md:grid-cols-2 gap-4"> <button
                type="submit"
            ...
            <button
              onClick={() => setIsOpen(false)}
              className="w-full text-xs mt-3 bg-gray-200 text-gray-700 py-3 rounded-lg hover:bg-gray-300 transition-all">
              Batal
            </button></div>
