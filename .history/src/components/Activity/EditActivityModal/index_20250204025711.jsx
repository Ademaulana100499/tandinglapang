      ...
      {isOpen && (
        <motion.div
          ...
          <motion.div
            ...
            className="bg-white p-4 shadow-xl w-full max-w-xs md:max-w-lg text-gray-800 relative rounded-lg overflow-auto max-h-[80vh]">
            <h3 className="text-2xl font-bold mb-2 text-center">Edit Acara</h3>
            <p className="text-gray-600 text-sm text-center">
              Perbarui informasi acara Anda.
            </p>
            <form
              className="w-full flex flex-col gap-4 overflow-y-auto max-h-[80vh]"
              ...
              <input
                ...
                className="p-2 text-sm rounded border border-gray-300 focus:ring-2 focus:ring-green-500 w-full"
              />
              <textarea
