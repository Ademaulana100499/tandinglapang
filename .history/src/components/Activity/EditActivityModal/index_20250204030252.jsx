          ...
          <motion.div
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <input
                ...
                className="p-1 rounded border border-gray-300 focus:ring-2 focus:ring-green-500 w-32"
              />
              <textarea
                ...
                className="p-1 rounded border border-gray-300 focus:ring-2 focus:ring-green-500 w-32 h-16"
              />
              <LocationDropdown
