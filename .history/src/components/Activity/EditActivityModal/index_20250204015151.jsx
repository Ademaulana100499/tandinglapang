    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="bg-black bg-opacity-60 fixed inset-0 flex justify-center items-center p-4 overflow-hidden">
          {" "}
          {/* Overflow hidden pada backdrop */}
          <motion.div
