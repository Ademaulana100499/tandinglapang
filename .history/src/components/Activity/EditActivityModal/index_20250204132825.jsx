          ...
          <motion.div
            ...
            <form
              ...
              <input
                ...
                className="p-2  text-xs xl:text-base rounded border border-gray-300 focus:ring-2 focus:ring-green-500 w-full"
              />
              <textarea
                ...
                className="p-2 text-xs rounded border border-gray-300 focus:ring-2 focus:ring-green-500 w-full"
              />
              ...
              <div className="grid text-xs grid-cols-1 md:grid-cols-2 gap-2">
                <button
                  type="submit"
                  className="w-full text-xs bg-green-600 text-white py-3 rounded-lg hover:bg-green-700 transition-all flex items-center justify-center">
                  {isLoading ? <BarLoader /> : "Perbarui Acara"}
                </button>{" "}
                <button
                  type="button"
                  onClick={() => setIsOpen(false)}
                  className="w-full text-xs bg-gray-200 text-gray-700 py-3 rounded-lg hover:bg-gray-300 transition-all">
                  Batal
                </button>
              </div>
            </form>
