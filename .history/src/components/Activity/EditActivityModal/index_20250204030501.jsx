      ...
      {isOpen && (
        <motion.div
          ...
          <motion.div
            ...
            className="bg-white p-4 shadow-xl w-full max-w-md md:max-w-xl text-gray-800 relative rounded-lg max-h-[80vh] overflow-hidden">
            <h3 className="text-lg font-bold mb-2 text-center">Edit Acara</h3>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <input
                ...
                className="p-1 text-xs rounded border border-gray-300 focus:ring-2 focus:ring-green-500 w-32"
              />
              <textarea
                ...
                className="p-1 text-xs rounded border border-gray-300 focus:ring-2 focus:ring-green-500 w-32 h-16"
              />
              <LocationDropdown
              ...
              <input
                ...
                className="p-1  text-xs  text-xs rounded border border-gray-300 focus:ring-2 focus:ring-green-500 w-32"
              />
              <input
                type="time"
            ...
            <div className="flex gap-2 mt-4">
              <button
                type="submit"
                className="flex-1  text-xs bg-green-600 text-white py-2 rounded-lg hover:bg-green-700 transition-all flex items-center justify-center">
                {isLoading ? <BarLoader /> : "Perbarui"}
              </button>
              <button
                onClick={() => setIsOpen(false)}
                className="flex-1 text-xs bg-gray-200 text-gray-700 py-2 rounded-lg hover:bg-gray-300 transition-all">
                Batal
              </button>
            </div>
          </motion.div>
