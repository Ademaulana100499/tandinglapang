...
export const CreateActivitySection = () => {
  ...
  const [selectedCategory, setSelectedCategory] = useState(""); // Pastikan state ini didefinisikan di sini
        ...
        <div className="flex flex-col">
          ...
          <form className="w-full" onSubmit={handleFormCreate}>
            <SportCategoryDropdown
              value={selectedCategory} // Menggunakan state selectedCategory
              onChange={(category) => {
                setSelectedCategory(category.id); // Mengubah kategori yang dipilih
