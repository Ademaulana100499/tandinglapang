...
const Authorization = ({ children }) => {
  ...
  const [isAuthenticated, setIsAuthenticated] = useState(false); // Default false agar loading spinner tampil
  ...
  if (!isAuthenticated || !hasAccess) {
    // Tampilkan loading spinner atau halaman kosong jika tidak terautentikasi atau tidak memiliki akses
    return (
