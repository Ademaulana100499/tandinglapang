...
const LocationAndSportCategoryDropdown = () => {
  ...
  // Mengambil seluruh data provinsi dengan data kota
  useEffect(() => {
  ...
  // Mengambil semua kategori olahraga tanpa pagination
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const response = await axios.get(
          `${process.env.NEXT_PUBLIC_API_URL}/sport-categories?is_paginate=false`
        );
