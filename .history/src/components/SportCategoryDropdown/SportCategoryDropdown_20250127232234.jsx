...
const LocationAndSportCategoryDropdown = () => {
  ...
  return (
    <div className="w-full mt-1 z-50 flex justify-center items-center max-w-6xl mx-auto">
      ...
      <div className="px-4">
        <button
          ...
          className="w-full px-4  bg-green-500 text-white rounded-lg hover:bg-green-600 transition duration-300">
          Cari
        </button>
      </div>
    </div>
