  ...
  return (
    <div className="w-full mt-1 z-50 max-w-6xl mx-auto">
      <div className="flex flex-wrap items-center gap-2 ">
        ...
        <div className=" min-w-30 border border-green-300  rounded-sm focus:ring-2 focus:ring-green-500 transition duration-200">
          <select
            value={selectedCategory}
            onChange={handleCategoryChange}
            className="w-full p-3 border border-green-300 rounded-sm">
