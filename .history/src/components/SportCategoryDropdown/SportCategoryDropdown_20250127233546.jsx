...
const LocationAndSportCategoryDropdown = () => {
  ...
  return (
    <div className="w-full mt-1 z-50 flex  items-center max-w-6xl mx-auto">
      ...
      <div className="px-4 w-1/6">
        <button
          ...
          className="w-full px-4 py-2 bg-black text-white rounded-lg hover:bg-green-200 transition duration-300">
          Cari Lapangan
        </button>
      </div>
    </div>
