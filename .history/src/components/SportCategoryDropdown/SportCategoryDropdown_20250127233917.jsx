    ...
    <div className="w-full mt-1 z-50 max-w-6xl mx-auto">
      <div className="flex  items-center gap-2 ">
        ...
        <div className=" min-w-60">
          <select
            ...
            className="w-full  border border-green-300 rounded-lg focus:ring-2 focus:ring-green-500 transition duration-200">
      ...
      <div className="w-1/6">
        <button
          ...
          className="w-full px-4 mt-4 py-2 bg-black text-white rounded-lg hover:bg-green-500 hover:text-black transition duration-300">
          Cari Lapangan
        </button>
      </div>
    </div>
