  ...
  useEffect(() => {
    const fetchLocations = async () => {
      try {
        ...
        // Cek jumlah provinsi yang diambil
        console.log("Jumlah Provinsi:", provinceData.length);
        ...
        for (let province of provinceData) {
          ...
          // Cek jumlah kota untuk setiap provinsi
          console.log(
            `Jumlah Kota di Provinsi ${province.province_name}:`,
            cityData.length
          );
        ...
        // Cek jumlah total lokasi yang sudah digabung
        console.log("Jumlah Lokasi yang Ditemukan:", allLocations.length);
