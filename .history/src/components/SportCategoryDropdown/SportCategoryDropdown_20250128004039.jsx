      ...
      <div className="flex flex-wrap items-center gap-2 ">
        <div className="min-w-60">
          <Select
            ...
            className="w-full p-2 border border-green-300 rounded-sm focus:ring-2 focus:ring-green-500 transition duration-200"
            styles={{
              menu: (provided) => ({
                ...provided,
                maxHeight: "300px", // Batasi tinggi menu dropdown
                overflow: "hidden", // Menghindari scroll ganda
              }),
              control: (provided) => ({
                ...provided,
                minHeight: "40px", // Menyesuaikan tinggi control jika diperlukan
              }),
            }}
          />
        </div>
        ...
        <div className="w-40 ">
          <button
            ...
            className="w-full px-4  py-2 bg-black text-white rounded-lg hover:bg-green-600 hover:text-black transition duration-300">
            Cari Lapangan
          </button>
        </div>
      </div>
