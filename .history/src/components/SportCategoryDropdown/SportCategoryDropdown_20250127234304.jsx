...
const LocationAndSportCategoryDropdown = () => {
  ...
  return (
    <div className="w-full flex justify-center items-center mt-5">
      <div className="bg-white shadow-xl rounded-full p-4 flex items-center gap-4 border border-gray-200 max-w-5xl w-full">
        ...
        <div className="flex-1">
          <select
            ...
            className="w-full p-2 text-sm border border-gray-300 rounded-full focus:ring-2 focus:ring-green-500 transition duration-200">
        ...
        <div>
          <button
            ...
            className="px-6 py-2 bg-black text-white rounded-full hover:bg-green-500 hover:text-black transition duration-300 text-sm">
            Cari Lapangan
          </button>
        </div>
      </div>
