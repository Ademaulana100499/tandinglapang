...
export const Navbar = () => {
  ...
  const handleScroll = () => {
    // Mengaktifkan navbar setelah scroll setengah layar
    ...
    // Menentukan ID yang sedang aktif
    ...
    sections.forEach((section) => {
      ...
      if (element) {
        ...
        // Periksa apakah bagian ini sudah cukup terlihat di layar (lebih dari setengah elemen terlihat)
        if (
          window.scrollY + window.innerHeight / 2 >= elementTop && // Scroll sudah mencapai setengah elemen
          window.scrollY + window.innerHeight / 2 < elementTop + elementHeight // Belum melewati bagian bawah elemen
        ) {
