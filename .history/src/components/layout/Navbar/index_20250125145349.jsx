...
export const Navbar = () => {
  ...
  const handleScroll = () => {
    // Mengatur apakah navbar harus aktif berdasarkan scroll
    ...
    // Menentukan ID yang sedang aktif berdasarkan scroll
    ...
    sections.forEach((section) => {
      ...
      if (element) {
        const sectionTop = element.offsetTop - 50; // Memberikan sedikit margin untuk efek halus
        const sectionBottom = sectionTop + element.offsetHeight;

        // Jika posisi scroll berada dalam area elemen
        if (window.scrollY >= sectionTop && window.scrollY < sectionBottom) {
          if (activeSection !== section) {
            // Hanya mengubah state jika section berbeda
  ...
  }, [activeSection]); // Dependency activeSection untuk memastikan perubahan hanya terjadi saat diperlukan
