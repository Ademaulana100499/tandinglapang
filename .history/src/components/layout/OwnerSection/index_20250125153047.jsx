...
export const OwnerSection = () => {
  return (
    <div className="bg-black">
      <section className="w-full  px-8 lg:py-24 sm:py-10 grid grid-cols-1 md:grid-cols-2 items-center gap-8 max-w-6xl mx-auto">
        <div>
          ...
          <button className="bg-green-500 text-white font-medium py-2 px-4 rounded transition-all hover:bg-green-700 active:scale-95">
