          ...
          <button
            onClick={(e) => {
              setFormData((prevFormData) => ({
                ...prevFormData, // Menyebarkan formData yang lama
                role: "admin", // Mengubah role menjadi admin
              }));
              setIsOpen(false);

              // Menambahkan timeout untuk menunda pembukaan modal
              setTimeout(() => {
                setIsRegisterOpen(true); // Membuka modal setelah delay
              }, 5000); // Set timeout dalam milidetik, misalnya 500ms (0.5 detik)
            }}
