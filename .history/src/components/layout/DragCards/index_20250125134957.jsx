...
export const DragCards = () => {
  return (
    <section
      id="home"
      className="relative grid min-h-screen w-full place-content-center overflow-hidden bg-neutral-950">
  ...
  return (
    <div id="home" className=" absolute top-0 inset-0 z-10" ref={containerRef}>
      <Card
        ...
        src="https://images.unsplash.com/photo-1701277050203-eabfa03e64eb?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        alt="Example image"
        rotate="6deg"
        top="10%"
        left="15%"
      ...
      <Card
        containerRef={containerRef}
        src="https://images.unsplash.com/photo-1621429198225-b8dc1604d0ac?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        alt="basket"
        rotate="-6deg"
        top="20%"
        left="35%"
