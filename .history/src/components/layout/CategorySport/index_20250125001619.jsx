...
const ClipPathLinks = () => {
  return (
    <div>
      ...
      <p className="flex items-center justify-center text-xl sm:text-xl md:text-1xl lg:text-2xl font-extralight   mb-10 text-black">
        <span>
          Jelajahi beragam pilihan olahraga yang sesuai dengan minat dan
          kebutuhanmu. Temukan lapangan terbaik untuk berlatih dan
          bersenang-senang!
        </span>
      </p>
