...
const ClipPathLinks = () => {
  return (
    <div>
      <p className="flex items-center justify-center text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold uppercase mb-3  text-black">
      ...
      <p className="flex items-center justify-center text-xl sm:text-xl md:text-1xl lg:text-2xl mb-10 text-black">
        <span>
          Jelajahi pilihan olahraga yang sesuai dengan kebutuhanmu. Temukan
          lapangan terbaik untuk berlatih dan bersenang-senang!
        </span>
      </p>
