...
const ClipPathLinks = () => {
  return (
    <div>
      <p className="flex items-center justify-center text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold uppercase  text-black">
        <span>Cari Kategori Olahraga Favoritmu</span>
      </p>
      <p className="flex items-center justify-center text-xl sm:text-5xl md:text-6xl lg:text-7xl font-bold uppercase mb-10 text-black">
        <span>
          Jelajahi berbagai pilihan olahraga yang sesuai dengan minat dan
          kebutuhanmu. Dari sepak bola hingga bulu tangkis, temukan tempat
          terbaik untuk berlatih dan bersenang-senang bersama teman!
        </span>
      </p>
