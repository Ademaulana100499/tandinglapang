...
const LocationBlock = () => (
  <Block className="col-span-12 flex flex-col items-center gap-4 md:col-span-3">
    ...
    {/* Tambahan Nomor Telepon dan WhatsApp */}
    <div className="flex flex-col items-center gap-2 text-lg font-medium text-zinc-800">
      <p>📞 Telp 1: +62 812-3456-7890</p>
      <p>📞 Telp 2: +62 857-9876-5432</p>
      <p>
        💬 WhatsApp:{" "}
        <a
