...
const HeaderBlock = () => (
  <Block className="col-span-12 row-span-2 md:col-span-6">
    <h1 className="mb-12 text-3xl sm:text-4xl  lg:text-6xl  md:text-6xl font-medium leading-tight">
...
const AboutBlock = () => (
  <Block className="col-span-12 text-3xl sm:text-4xl  lg:text-6xl  md:text-6xl leading-snug">
    <p>
      <span className="text-black text-4xl sm:text-4xl  lg:text-6xl  md:text-6xl">
        Misi kami{" "}
      </span>
      <span className="text-zinc-600">
