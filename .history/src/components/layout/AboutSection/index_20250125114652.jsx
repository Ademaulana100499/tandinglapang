...
const LocationBlock = () => (
  <Block className="col-span-12 flex flex-col items-center gap-4 md:col-span-3">
    <p className="text-center text-xl font-semibold">Lokasi Kami</p>
    ...
    {/* Kontak */}
    <div className="text-center">
      <p className="font-semibold text-lg">Hubungi Kami</p>
      <p className="text-zinc-600">📞 0812-3456-7890</p>
      <p className="text-zinc-600">✉️ info@example.com</p>
    </div>
    ...
    <div className="flex gap-3">
      ...
      <a href="#" className="text-2xl text-sky-400">
        <FiTwitter />
      </a>
