...
const Block = ({ className, ...rest }) => {
  return (
    <motion.div
      ...
      className={twMerge(
        "col-span-4 rounded-lg border border-zinc-700 bg-neutral-200 bg-transparent p-6",
        className
      )}
      {...rest}
    />
...
const HeaderBlock = () => (
  <Block className="col-span-12 row-span-2 md:col-span-6">
    <h1 className="mb-12 text-3xl font-medium leading-tight">
      <span className="text-white text-4xl">Sewa</span>
      <span className="text-green-500 text-4xl">Lapang {""}</span>
...
const AboutBlock = () => (
  <Block className="col-span-12 text-3xl leading-snug">
    <p>
      <span className="text-green-500">Misi kami </span>
      <span className="text-zinc-600">
