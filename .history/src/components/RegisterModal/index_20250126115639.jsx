...
export const RegisterModal = ({ isOpen, setIsOpen }) => {
  ...
  // State untuk role (user atau owner)
          ...
          <motion.div
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <form className="w-full">
                ...
                {/* Tambahkan opsi role */}
                <div className="mb-4">
                  <label className="block text-gray-600 mb-2">Pilih Role</label>
                  <select
                    value={role}
                ...
                <button
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    handleFormRegister(role); // Passing role to the registration handler
                  }}
