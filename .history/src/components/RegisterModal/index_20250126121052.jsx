...
export const RegisterModal = ({ isOpen, setIsOpen }) => {
  ...
  const handleSubmit = (e) => {
    ...
    handleFormRegister(e); // Call handleFormRegister from the custom hook
  };
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="flex mb-4">
                <button
                  ...
                  className={`${
                    role === "user" ? "bg-green-600 text-white" : "bg-gray-200 text-gray-700"
                ...
                <button
                  ...
                  className={`${
                    role === "owner" ? "bg-green-600 text-white" : "bg-gray-200 text-gray-700"
                  } py-2 px-4 rounded-r-lg w-full hover:bg-green-700 transition-all`}>
                  Owner Lapangan
                </button>
              </div>

              {/* Form untuk User dan Owner */}
