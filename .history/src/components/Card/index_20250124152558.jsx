...
const Cards = () => {
  ...
  return (
    <div className="absolute inset-0 z-10" ref={containerRef}>
      ...
      <Card
        containerRef={containerRef}
        src="https://images.unsplash.com/photo-1646343251574-a7b03ee3dbaf?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        alt="Example image"
        rotate="12deg"
        top="45%"
        left="60%"
