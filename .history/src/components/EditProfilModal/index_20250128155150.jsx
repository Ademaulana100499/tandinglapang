...
import useEditProfile from "@/hooks/useEditProfile"; // pastikan hook sudah tersedia
import { BarLoader } from "../Loading";

export const EditProfileModal = ({ isOpen, setIsOpen, userData }) => {
  const { formData, setFormData, handleEditProfile, isLoading } =
    useEditProfile(setIsOpen);
