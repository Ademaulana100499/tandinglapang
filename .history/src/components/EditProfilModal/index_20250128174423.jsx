  ...
  useEffect(() => {
    if (data && !isInitialized) {
      setFormData({
        ...
        password: data.password || "", // Pastikan password juga diisi
        c_password: data.c_password || "", // Pastikan confirm password juga diisi
        role: data.role || "",
      });
      setIsInitialized(true); // Mencegah update ulang setiap re-render
    }
  }, [data, isInitialized, setFormData]);
