...
export const LoginModal = ({ isOpen, setIsOpen }) => {
  ...
  const { formData, setFormData, handleFormLogin, isLoading } =
    useLogin(setIsOpen);
          ...
          <motion.div
            ...
            <motion.div
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <form className="w-full" onSubmit={handleFormLogin}>
                  <input
                    type="email"
                    placeholder="Email"
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full p-3 rounded border border-gray-300 focus:ring-2 mb-3  focus:ring-green-500"
                    />
                    <button
                      type="button"
