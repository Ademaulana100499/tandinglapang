...
const SpringModal = ({ isOpen, setIsOpen }) => {
  ...
  const handleRegister = () => {
    if (!formData.email || !formData.password || !formData.name) {
      Swal.fire({
        title: "Semua bidang harus diisi!",
        icon: "error",
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600 mb-6">
                {view === "forgotPassword"
                  ...
                  : view === "register"
                  ? "Buat akun baru untuk mulai menjelajahi fitur kami!"
                ...
                {view !== "forgotPassword" && (
                  <div className="relative mb-4">
                    ...
                    <button
                      ...
                      <Image
                        src={showPassword ? "/close.png" : "/open.png"}
                        width={28}
                        height={28}
                        alt="eye-toggle"
                      />
              ...
              <div className="flex justify-between mt-4 text-sm">
                ...
                {(view === "forgotPassword" || view === "register") && (
                  <button
