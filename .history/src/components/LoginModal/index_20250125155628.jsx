      ...
      {isOpen && (
        <motion.div
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-green-400 to-green-500 text-white p-6 rounded-lg w-full max-w-lg shadow-xl cursor-default relative overflow-hidden max-h-[80vh] overflow-y-auto">
