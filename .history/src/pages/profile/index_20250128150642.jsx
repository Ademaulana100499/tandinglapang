...
const ProfilePage = ({ data }) => {
  ...
  return (
    <div>
      <Navbar />
      <div className="min-h-screen flex flex-col container mx-auto py-10 px-6 md:px-10">
        <h1 className="text-3xl font-bold text-center mb-8 text-green-600">
          Profil Saya
        </h1>

        <div className="bg-white shadow-lg p-8 w-full max-w-4xl border-2 border-green-400 mx-auto">
          ...
          <div className="mt-8 border-t border-green-500 pt-6">
            ...
            {isOpen && (
              <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                <div className="bg-white p-8 rounded-lg shadow-lg relative w-full max-w-4xl mx-4">
                  <button
                  ...
                  <div className="space-y-6">
                    <input
                      ...
                      className="w-full p-4 border-2 border-gray-300 rounded-md focus:outline-none focus:border-green-600"
                    />
                    <input
                      type="email"
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between mt-6">
                      <button
                        onClick={() => setIsOpen(false)}
                        className="px-6 py-3 bg-gray-300 text-gray-800 rounded-md hover:bg-gray-400 mb-4 sm:mb-0">
                        Batal
                      </button>
                      <button
