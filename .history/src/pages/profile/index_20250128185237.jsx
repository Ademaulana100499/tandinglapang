          ...
          <div className="flex flex-col md:flex-row items-center space-y-4 gap-6 md:space-y-0 md:space-x-8">
            <div className="w-36 h-36 relative">
              <img
                ...
                className="w-full h-full mx-auto border-4 border-black object-cover rounded-full shadow-lg transform transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-2xl"
              />
