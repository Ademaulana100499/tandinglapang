...
const ProfilePage = ({ data }) => {
  ...
  return (
    <div>
      <Navbar />
      <div className="min-h-screen flex flex-col container mx-auto py-10 px-4">
                ...
                <div className="bg-white p-6 rounded-lg shadow-lg relative w-full max-w-3xl mx-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between mt-4">
                      <button
                        onClick={() => setIsOpen(false)}
                        className="px-6 py-2 bg-gray-300 text-gray-800 rounded-md hover:bg-gray-400 mb-4 sm:mb-0">
                        Batal
                      </button>
                      <button
