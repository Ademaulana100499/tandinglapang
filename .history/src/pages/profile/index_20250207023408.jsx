...
import { EditProfileModal } from "@/components/Authentication/EditProfilModal";
  ...
  return (
    <div>
      ...
      <div className="min-h-screen bg-green-500 flex flex-col w-full  py-10 px-6 md:px-12">
        ...
        <div className="bg-white shadow-lg p-8 w-full max-w-6xl border-2 border-black mx-auto">
