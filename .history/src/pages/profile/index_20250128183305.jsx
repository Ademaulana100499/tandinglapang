        ...
        <div className="bg-white shadow-lg p-8 w-full max-w-5xl border-2 border-green-400 mx-auto">
          <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-8">
            ...
            <div className="space-y-6">
              <div className="flex flex-col md:flex-row md:items-center md:space-x-6 p-4 bg-green-100 rounded-lg border-2 border-green-500 shadow-md hover:shadow-xl transition-shadow duration-300">
                <p className="text-lg md:text-xl font-semibold text-green-700">
                  <strong>Nama:</strong>
                </p>
                <p className="text-lg md:text-xl text-green-900">{data.name}</p>
              </div>
