...
const AllSportCategories = () => {
  ...
  useEffect(() => {
    fetchCategories();
  }, [isOpenEditCategory, isOpenCreateCategory]);
  ...
  return (
    <div className="min-h-screen max-w-screen container mx-auto p-5">
      ...
      <CreateCategorySport
        ...
        onCreateComplete={() => {
          setIsOpenCreateCategory(false); // Menutup modal setelah aksi selesai
          fetchCategories(); // Panggil fetch setelah kategori dibuat
        }}
      />
      ...
      <EditCategorySport
        ...
        onEditComplete={() => {
          setIsOpenEditCategory(false); // Menutup modal setelah aksi selesai
          fetchCategories(); // Panggil fetch setelah kategori diedit
        }}
      />
    </div>
  );
