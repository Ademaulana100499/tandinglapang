...
const MyTransaction = ({ transactions, page, lastPage }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <Navbar />
      <div className="min-h-screen flex flex-col justify-between bg-green-500 container mx-auto py-10 px-4">
        <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {transactions.map((transaction) => (
                  <div
                    ...
                    className="bg-white shadow-lg p-6 transition transform hover:scale-105 cursor-pointer border-2 border-gray-200 hover:border-green-500">
