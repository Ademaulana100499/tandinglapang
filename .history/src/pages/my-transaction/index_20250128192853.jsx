      ...
      <div className="min-h-screen flex flex-col  justify-between   container mx-auto py-10 px-4">
        <div>
          ...
          {transactions.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center space-y-4 py-10 bg-white rounded-sm shadow-xl">
              <svg
              ...
              <p className="text-center text-sm text-gray-600">
                Segera lakukan transaksi untuk melihat transaksi kamu.
              </p>
            </div>
          )}
        </div>
