...
export async function getServerSideProps({ req, query }) {
  ...
  try {
    ...
    const { role, roleId } = req.cookies; // Menggunakan `req.cookies` yang benar
    console.log(role);
    console.log(roleId);
    const filteredData =
    ...
    const transactions = filteredData || []; // Gunakan filteredData yang sudah difilter
    const currentPage = res.data?.current_page || 1; // Ganti dengan current_page
    const lastPage = res.data?.last_page || 1; // Ganti dengan last_page
