...
export async function getServerSideProps({ req }) {
  ...
  try {
    // Loop untuk mengambil semua halaman data transaksi
    do {
      ...
      // Filter transaksi berdasarkan user jika role adalah "user"
      if (role === "user" && roleId) {
      ...
      currentPage++;
    } while (currentPage <= lastPage); // Loop hingga semua halaman diambil
