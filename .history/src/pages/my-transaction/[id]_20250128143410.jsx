...
const DetailMyTransaction = ({ data }) => {
  ...
  return (
    <div>
      <Navbar />
      < className="min-h-screen flex flex-col justify-center items-center container mx-auto py-10 px-4">
  <h1 className="text-3xl font-bold text-center mb-6 text-green-600">
    Detail Transaksi
  </h1>
  
  <Link to="/my-transaction" className="text-blue-500 hover:text-blue-700">
