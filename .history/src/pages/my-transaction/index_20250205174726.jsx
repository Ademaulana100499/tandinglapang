...
export async function getServerSideProps({ req, query }) {
  ...
  try {
    ...
    const transactions = filteredData.data?.result?.data || [];
    const currentPage = filteredData.data?.result?.current_page || 1;
    const lastPage = filteredData.data?.result?.last_page || 1;
