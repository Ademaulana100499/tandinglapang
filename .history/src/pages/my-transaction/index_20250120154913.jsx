...
export async function getServerSideProps({ req, query }) {
  ...
  try {
    ...
    // Ensure totalPages is always defined (fallback to 1 if undefined)
    const totalPages = total_pages ?? 1;

    return { props: { transactions: result, page, totalPages } };
  } catch (error) {
    console.error("Error fetching transactions:", error);
    return { props: { transactions: [], page, totalPages: 1 } };
  }
}
