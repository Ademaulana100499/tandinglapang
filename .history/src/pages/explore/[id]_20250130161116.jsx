...
const Schedule = ({ data }) => {
  ...
  return (
    <section
      ...
      <img
        src={`https://maps.googleapis.com/maps/api/staticmap?center=${data.latitude},${data.longitude}&zoom=15&size=600x300&maptype=roadmap&markers=color:red%7C${data.latitude},${data.longitude}&key=YOUR_GOOGLE_MAPS_API_KEY`}
        alt="Lokasi Peta"
