      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="w-full h-full overflow-hidden relative bg-black flex justify-between ">
            ...
            <motion.div
              ...
              animate="open"
              exit="closed"
              className="px-4 py-2 flex items-start bg-black/40 backdrop-blur-sm text-white">
              <p>{item}</p>
            </motion.div>
