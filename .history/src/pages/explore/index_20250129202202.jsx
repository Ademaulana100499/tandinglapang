      ...
      <Authorization>
        ...
        <div id="explore " className="h-full   bg-green-500 ">
          <section className="py-8   ">
            <div className="text-center w-full mb-6 p-1 md:p-4 sm:p-1 bg-gradient-to-r from-green-500 to-green-700">
              ...
              <p className="text-sm sm:text-lg text-gray-100 mt-2 sm:mt-3">
                Temukan lawan sparring sesuai keahlianmu! Pilih kategori
                olahraga favorit dan tantang lawan terbaik!
              </p>
              <p className="text-xs sm:text-md text-white mt-2 italic">
                "Sparring bukan hanya bertanding, tapi juga meningkatkan skill
                dan membangun semangat sportivitas!"
              </p>
            </div>
            ...
            <div className="flex flex-col px-8 lg:flex-row h-fit lg:h-[450px] bg-black w-full max-w-6xl mx-auto overflow-hidden">
              {data.length > 0 ? (
                data.map((item) => (
                  <Panel
                    key={item.id}
