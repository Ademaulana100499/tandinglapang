    ...
    <div>
      <Authorization>
        <WarpBackground className="bg-green-500 min-h-screen p-0 ">
          <Navbar />
          <section id="explore  py-16 px-8">
            <div className="text-center pt-8 bg-transparent bg-opacity-50 ">
            ...
            <div className="flex flex-col lg:flex-row h-fit lg:h-[450px] px-4  w-full max-w-6xl mx-auto overflow-hidden">
              {data.length > 0 ? (
                data.map((item) => (
                  <Panel
                    key={item.id}
