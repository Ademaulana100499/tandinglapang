...
const ActivityPage = ({ data, page }) => {
  ...
  return (
    <div>
      <Authorization>
        <Navbar />
        <WarpBackground className="bg-green-500 bg-transparent bg-opacity-50 p-2">
          <section id="explore ">
            <div className="text-center mb-6 p-4 bg-transparent bg-gradient-to-r from-green-500 to-green-700 bg-opacity-50 -mx-4">
