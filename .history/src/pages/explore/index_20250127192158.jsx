          ...
          <div className="flex flex-col lg:flex-row h-fit lg:h-[450px] bg-black w-full max-w-6xl mx-auto shadow overflow-hidden">
            {data.length > 0 ? (
              ...
              <div className="w-full flex justify-center items-center text-white text-lg p-10 relative">
                ...
                <motion.div
                  className="z-10 relative text-center p-4 rounded-lg shadow-xl bg-gradient-to-r from-red-500 via-yellow-500 to-pink-500"
                  initial={{ opacity: 0, scale: 0.8 }}
                  animate={{ opacity: 1, scale: 1 }}
                  transition={{ duration: 1 }}>
                  <p className="text-2xl font-bold animate__animated animate__fadeIn animate__delay-1s">
