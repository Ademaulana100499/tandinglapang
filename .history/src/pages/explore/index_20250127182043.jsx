    ...
    <div>
      <Authorization>
        ...
        <section className="p-4 bg-green-600">
          ...
          <div className="flex flex-col lg:flex-row h-fit lg:h-[450px] bg-slate-200 w-full max-w-6xl mx-auto shadow overflow-hidden">
            {data.map((item) => (
              <Panel
                key={item.id}
                open={open}
  ...
  return (
    <>
      <button
        ...
        <div className="w-6 lg:w-full aspect-square bg-gray-600 text-white grid place-items-center">
          <Icon />
        </div>
