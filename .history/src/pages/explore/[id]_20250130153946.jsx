...
const Schedule = ({ data }) => {
  ...
  return (
    <section
      ...
      <div className=" flex items-center justify-between border-b border-zinc-800 px-3 pb-9">
        <motion.h1
        ...
        <div className="flex items-center text-end text-sm uppercase text-zinc-500">
          <FiMapPin />
        </div>
      </div>
