...
const ActivityPage = ({ data, page }) => {
  ...
  return (
    <div>
      <Authorization>
        <WarpBackground className="bg-gray-700 min-h-screen p-0 ">
          <Navbar />
          <section id="explore  p-4">
            <div className="text-center mb-6 p-4 bg-transparent bg-opacity-50 ">
              <h2 className="uppercase sm:text-4xl text-3xl font-extrabold text-green-500 flex justify-center items-center gap-2 sm:gap-3 ">
