          ...
          <div className="flex flex-col lg:flex-row h-fit lg:h-[450px] w-full max-w-6xl mx-auto shadow overflow-hidden">
            {data.map((item) => (
              <Panel
                ...
                Icon={FiBarChart}
                title={item.title}
                imgSrc={item.imgSrc || "https://example.com/your-image.jpg"}
...
export const Panel = ({ open, setOpen, id, Icon, title, description }) => {
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="w-full h-full overflow-hidden relative bg-[url('https://www.dailysports.id/upload/xlarge/c8f976da413050fa5cd376b956a9fda2.jpg')] flex items-end">
            <motion.div
            ...
            <motion.div
              ...
              animate="open"
              exit="closed"
              className="px-4 py-2 bg-green-600 backdrop-blur-sm text-white">
              <p onClick={() => router.push(`/explore/${item.id}`)}>Detail</p>
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
