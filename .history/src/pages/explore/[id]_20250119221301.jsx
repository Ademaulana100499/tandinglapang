  ...
  return (
    <div>
      ...
      <div className="container mx-auto p-4">
        <Link href="/explore">
          className="text-blue-500 hover:underline mb-4 inline-block" Back
        </Link>
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg">
          ...
          <p className="mb-2">
            ...
            <del className="text-red-500">
              Rp {data.price_discount?.toLocaleString() || "N/A"}
            </del>
          </p>
          <p className="mb-2">
          ...
          <p className="mb-4">
            ...
            {data.organizer?.name || "N/A"} ({data.organizer?.email || "N/A"})
          </p>
