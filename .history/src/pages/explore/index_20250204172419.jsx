          ...
          <section id="explore py-16 px-4">
            <div className="text-center pt-8 px-4 bg-transparent bg-opacity-50">
              ...
              {!isAdmin ? (
                ...
                <p className="text-xl sm:text-xl lg:text-2xl md:text-2xl font-semibold text-black dark:text-white">
                  Sebagai admin, kamu bisa membuat acara sparring untuk anggota!
                </p>
              )}
            </div>
            <div className="p-4 ">
