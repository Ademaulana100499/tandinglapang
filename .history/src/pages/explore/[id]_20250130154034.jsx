...
const Schedule = ({ data }) => {
  ...
  return (
    <section
      ...
      <div className="mb-9 flex items-center justify-between border-b border-zinc-800 px-3 ">
        <motion.h1
          initial={{ y: 48, opacity: 0 }}
          whileInView={{ y: 0, opacity: 1 }}
          transition={{ ease: "easeInOut", duration: 0.75 }}
          className="mb-20 text-4xl font-black flex items-center  uppercase text-zinc-50">
          {data.title}
        </motion.h1>
        <div className="flex items-center text-end text-4-xl uppercase text-zinc-500">
          <FiMapPin />
        </div>
      </div>
