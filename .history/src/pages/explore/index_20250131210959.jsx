                  ...
                  <Panel
                    ...
                    imgSrc={
                      Array.isArray(
                        ...
                        ? imageMap[item.sport_category.name.toLowerCase()][0] // Mengambil gambar pertama
                        : imageMap["default"][0] // Jika kategori tidak ditemukan, ambil gambar pertama dari default
                    }
                    item={item.address}
                  />
                ))
