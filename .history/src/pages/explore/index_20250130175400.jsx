    ...
    <div>
      <Authorization>
        ...
        <WarpBackground className="bg-green-500 p-2">
          <section id="explore ">
            <div className="text-center mb-6 p-4 bg-transparent  bg-gradient-to-r from-green-500 to-green-700 bg-opacity-50 ">
              <h2 className="uppercase sm:text-4xl font-extrabold text-black flex justify-center items-center gap-2 sm:gap-3 -mx-4">
