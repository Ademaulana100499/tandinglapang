...
export async function getServerSideProps(context) {
  try {
    ...
    const { city_id, sport_category_id, page = 1 } = context.query;

    // Menyiapkan URL dengan parameter query
    const url = `${
      process.env.NEXT_PUBLIC_API_URL
    }/sport-activities?is_paginate=false&per_page=5&page=${page}&sport_category_id=${
      sport_category_id || ""
    }&city_id=${city_id || ""}`;
