...
const Schedule = ({ data }) => {
  ...
  return (
    <section
      ...
      <div className="mb-9 p-14 flex items-center justify-between border-b border-zinc-800 px-3 ">
        <motion.h1
      ...
      <ScheduleItem title="Tanggal" date={data.date} />
      <ScheduleItem title="Waktu" date={data.time} />
...
const ScheduleItem = ({ title, date, location }) => {
  return (
    <motion.div
      ...
      whileInView={{ y: 0, opacity: 1 }}
      transition={{ ease: "easeInOut", duration: 0.75 }}
      className="mb-9 flex items-center justify-between border-b border-zinc-800 px-3 pb-4">
      <div>
