          ...
          <div className="text-center pt-8 px-4 bg-transparent bg-opacity-50">
            ...
            {role === "admin" ? (
              <WordRotate
                ...
                words={[
                  "Sebagai penyelenggara, kamu memiliki kesempatan untuk membuat dan mengatur acara sparring bagi anggota lainnya.",
            ...
            {paginatedData.length > 0 ? (
              paginatedData.map((item) => (
                <Panel
                  ...
                  price={item.price}
                  sport_category={item.sport_category?.name}
                />
              ))
            ) : (
...
export async function getServerSideProps(context) {
  const { role, roleId, token } = context.req.cookies;
