            ...
            {data.length > 0 ? (
              data.map((item) => (
                <Panel
                  ...
                  Icon={
                    iconMap[
                      item.sport_category.name.toLowerCase() || defaultIcon
                    ]
                  }
                  title={item.title}
                  imgSrc={
            ...
            {data.length > 0 && (
              <div className="flex justify-center mt-4">
                <button
                  ...
                  disabled={page <= 1}
                  className="px-6 py-3 bg-white text-gray-800 rounded-l-lg shadow-md hover:bg-gray-100 disabled:opacity-50 transition-colors flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-white text-gray-800 rounded-r-lg shadow-md hover:bg-gray-100 disabled:opacity-50 transition-colors flex items-center gap-2">
                  Next
                  <MdSportsSoccer className="text-lg" />
                </button>
              </div>
