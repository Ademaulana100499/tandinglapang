        ...
        <WarpBackground className="bg-green-500 min-h-screen p-0 ">
          ...
          <section id="explore  py-16 px-4">
            <div className="text-center pt-8 px-4 bg-transparent bg-opacity-50 ">
              ...
              <WordRotate
                duration={4000}
                className="text-1xl sm:text-xl  lg:text-2xl  md:text-2xl font-bold text-black dark:text-white"
                words={[
            ...
            <div className="flex flex-col lg:flex-row h-fit lg:h-[450px] p-4 md:p-0 w-full max-w-6xl mx-auto overflow-hidden">
              {data.length > 0 ? (
                data.map((item) => (
                  <Panel
                    key={item.id}
