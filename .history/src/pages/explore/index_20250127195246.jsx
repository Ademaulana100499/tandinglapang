            ...
            {data.length > 0 && (
              <div className="flex justify-center mt-4">
                <button
                  ...
                  disabled={page <= 1}
                  className="px-4 py-2 bg-gray-300 text-gray-700 rounded-l-lg hover:bg-gray-400 disabled:bg-gray-200">
                  Previous
                </button>
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-gray-300 text-gray-700 rounded-r-lg hover:bg-gray-400 disabled:bg-gray-200">
                    {page + 1}
                  </button>
                </div>
                <button
