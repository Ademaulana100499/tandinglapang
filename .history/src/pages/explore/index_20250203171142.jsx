            ...
            <div className="p-4 ">
              <div className="max-w-6xl mx-auto ">
                <button
                  ...
                  className="text-white px-4 py-2 bg-green-600 hover:bg-green-700 rounded-sm mt-4 mb-4 transition duration-300">
                  Buat Acara Anda Sekarang <i className="fa fa-row-right"></i>
                </button>
              </div>
