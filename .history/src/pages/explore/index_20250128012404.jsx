...
const ActivityPage = ({ data, page }) => {
  ...
  return (
    <div>
      <Authorization>
        <Navbar />
        <div id="explore " className="h-full   bg-green-500 px-10">
          <section className="p-8   ">
            <div className="text-center mb-6 p-6 bg-gradient-to-r from-green-500 to-green-700 ">
              <h2 className="text-4xl font-extrabold text-black flex justify-center items-center gap-3">
                <GiSoccerBall className="text-white text-5xl animate-bounce" />
                Temukan Lapangan Olahraga Terbaikmu!
                <MdSportsBaseball className="text-white text-5xl animate-bounce" />
              </h2>
              <p className="text-lg text-gray-100 mt-3">
                Jadilah yang pertama merasakan sensasi bermain di lapangan
                terbaik! Pilih kategori olahraga favoritmu dan mulai petualangan
                seru bersama teman-teman!
              </p>
              <p className="text-md text-white mt-2 italic">
                "Olahraga bukan hanya tentang permainan, tapi tentang semangat
                dan kebersamaan!"
              </p>
            </div>
              ...
              {data.length > 0 && (
                <div className="flex justify-center mt-4">
                  ...
                  <button
                    ...
                    Next
                    <MdSportsFootball className="text-lg" />
                  </button>
                </div>
              )}
            </div>
