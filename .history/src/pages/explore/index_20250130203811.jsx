        ...
        <WarpBackground className="bg-green-500  p-2">
          <section id="explore ">
            <div className="text-center mb-6 p-4 bg-transparent bg-opacity-50 ">
              <h2 className="uppercase sm:text-4xl text-lg font-extrabold text-black flex justify-center items-center gap-2 sm:gap-3 ">
            ...
            <div className="flex flex-col lg:flex-row h-fit lg:h-[450px] bg-black w-full max-w-6xl mx-auto overflow-hidden">
              {data.length > 0 ? (
                ...
                <div className="w-full flex justify-center items-center text-white text-lg p-10 relative">
                  ...
                  <motion.div
                    className="relative text-center p-6 shadow-xl bg-transparent bg-opacity-50 transform transition-all duration-500"
