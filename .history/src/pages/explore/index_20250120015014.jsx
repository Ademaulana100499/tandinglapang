...
export async function getServerSideProps(context) {
  try {
    const { province, city, category } = context.query;

    // Buat objek query params hanya jika ada filter yang digunakan
    const queryParams = {
      is_paginate: false,
      per_page: 5,
      page: 1,
    ...
    // Tambahkan filter jika ada yang dipilih
    if (category) queryParams.sport_category_id = category;
