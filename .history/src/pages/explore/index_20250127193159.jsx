          ...
          <div className="flex flex-col lg:flex-row h-fit lg:h-[450px] bg-black w-full max-w-6xl mx-auto shadow overflow-hidden">
            {data.length > 0 ? (
              ...
              <div className="w-full flex justify-center items-center text-white text-lg p-10 relative">
                <div className="absolute  bg-green-800 "></div>
                <motion.div
                  className="z-10 relative text-center p-6 rounded-lg shadow-xl bg-gradient-to-r from-green-400 to-green-700 transform transition-all duration-500"
                  initial={{ opacity: 0, scale: 0.8 }}
                  animate={{ opacity: 1, scale: 1 }}
                  transition={{ duration: 1 }}>
                  <div className="flex justify-center items-center gap-4 mb-4">
                    <MdMoodBad className="text-4xl text-black animate__animated animate__fadeIn" />
